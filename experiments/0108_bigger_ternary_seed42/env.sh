...
export RUN_ID="0108_bigger_ternary_seed42"
...
# 0108: SEED=42 cross-seed confirm of 0107 (bigger ternary SSM, NUM_UNIQUE_LAYERS=5).
# 0107 single-seed = 1.5256. Need 2-seed mean to compete with 0102/0105 mean 1.5462
# for promote.
export SEED=42
