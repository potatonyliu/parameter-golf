...
export RUN_ID="0109_pure_attn_prod"
...
# 0109: pure attention at production batch — SSM-contribution-at-scale anchor.
# Fork from 0098. Replace the parallel attn||mamba2 stack with pure attn at all
# 3 unique layers. Tests whether the SSM contribution observed at MPS-200
# (-0.085 BPB vs pure-attn 0058/0059) preserves at production batch.
export ATTN_LAYER_POSITIONS=0,1,2
export PARALLEL_LAYER_POSITIONS=
export MAMBA2_LAYER_POSITIONS=
# Production batch + canonical LR + 1k steps to match 0103.
