...
class Hyperparameters:
    ...
    # 0117 dendrocentric layer v1: sparse-selection MLP replacement. When
    # DENDROCENTRIC=0 (default), each Block uses the standard MLP/SwiGLU path —
    # byte-identical to parent 0107. When =1, each Block's MLP is replaced by
    # DendrocentricLayer (M dendrites, K-sparse top-K STE, sigmoidal NMDA-like
    # nonlinearity, ternary BitLinear output projection).
    ...
    dendro_alpha = float(os.environ.get("DENDRO_ALPHA", "1.0"))
