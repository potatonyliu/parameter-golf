...
export RUN_ID="0119_ema_n5_ternary_beta99"
...
export EMA_BETA=0.99
# 0119: EMA_BETA=0.99 (window=100) replaces 0116's beta=0.999 (window=1000) which
# was wrong for 1k smoke (shadow lagged to near-init weights, val landed 2.20).
# At beta=0.99, shadow captures last ~100 steps = late-training stability.
# Predicted val ≈ 0107 (1.5256) if EMA implementation is correct. Confirms the
# infrastructure works AND that 0116's catastrophic result was a hyperparameter
# mismatch (predicted in scratch/2026-04-29_ema_derivation.md), not a bug.
