...
export RUN_ID="0113_full_sel_rescue_lr_third"
...
# 0113: full-selectivity rescue. 0106 (full-sel + canonical LR=0.045 + production
# batch 131072) DIVERGED (val 3.54). Never re-ran with lower LR. Tests whether
# "kill > full at production scale" was an LR-cliff artifact or genuinely
# architectural. If full-sel @ LR/3 trains stably AND lands within +/- 0.020 BPB
# of 0103 (1.4587), kill-vs-full is an LR-tuning question. If it diverges or
# lands much worse, kill > full holds beyond exclusion.
export MAMBA2_KILL_SELECTIVITY=0
export MATRIX_LR=0.015
