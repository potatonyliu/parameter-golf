...
export RUN_ID="0105_ssm_frontier_ternary_seed42"
...
# 0105: SEED=42 confirmation of 0102's compound win.
# 0102 single-seed pre-quant 1.5414 at SSM frontier + ternary + production batch +
# canonical LR. This run is byte-identical except SEED=42 to give us the 2-seed mean
# for promote consideration. If σ_pair(0102, 0105) ≪ Δ vs nearest-comparator (0101 at
# 1.5739, Δ=-0.032), then promote-quality.
export SEED=42
