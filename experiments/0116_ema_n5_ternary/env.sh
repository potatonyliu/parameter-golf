...
export RUN_ID="0116_ema_n5_ternary"
...
# EMA_WARMUP_OFFSET defaults to LR_WARMUP_STEPS (=30). Pre-warmup, shadow tracks
# current weights with no decay (avoids averaging random init).
